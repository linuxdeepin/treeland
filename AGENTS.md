...
- New source files must include an SPDX line consistent with this repo, typically <!-- REUSE-IgnoreStart -->`SPDX-License-Identifier: Apache-2.0 OR LGPL-3.0-only OR GPL-2.0-only OR GPL-3.0-only`<!-- REUSE-IgnoreEnd -->.
