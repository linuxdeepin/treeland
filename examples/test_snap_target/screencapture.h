...
public:
    ...
    // One captured output: its logical geometry (xdg-output coordinates) and
    // the raw captured image (buffer pixel size).
    ...
    // Captures every output separately via ext-image-copy-capture. Returns an
    // empty list on failure.
    QList<CapturedOutput> captureOutputs();
