 ...
 * Generation time: 2025-02-27T16:58:50
...
class dconfig_org_deepin_treeland_user : public QObject {
    ...
    Q_CLASSINFO("DConfigKeyList", "activeColor;currentWorkspace;cursorBlink;cursorBlinkTime;cursorSize;cursorThemeName;defaultBackground;dndDragThreshold;doubleClickDistance;doubleClickTime;font;fontSize;forceSoftwareCursor;iconThemeName;lostScreen;maxWorkspace;monoFont;numWorkspace;preferDark;showOnLock;themeName;windowOpacity;windowRadius;windowThemeType;windowTitlebarHeight")
...
public:
    ...
    Q_INVOKABLE bool isDefaultValue(const QString &key) const {
        ...
        if (key == QStringLiteral(u"\u0063\u0075\u0072\u0072\u0065\u006e\u0074\u0057\u006f\u0072\u006b\u0073\u0070\u0061\u0063\u0065"))
            return currentWorkspaceIsDefaultValue();
    ...
    Q_INVOKABLE bool currentWorkspaceIsDefaultValue() const {
...
private:
    ...
    void updateValue(const QString &key, const QVariant &fallback = QVariant()) {
        ...
        if (key == QStringLiteral(u"\u0077\u0069\u006e\u0064\u006f\u0077\u0052\u0061\u0064\u0069\u0075\u0073")) {
            markPropertySet(22, !m_config.loadRelaxed()->isDefaultValue(key));
            auto newValue = qvariant_cast<qlonglong>(value);
            QMetaObject::invokeMethod(this, [this, newValue, key, value]() {
                Q_ASSERT(QThread::currentThread() == this->thread());
        ...
        if (key == QStringLiteral(u"\u0077\u0069\u006e\u0064\u006f\u0077\u0054\u0068\u0065\u006d\u0065\u0054\u0079\u0070\u0065")) {
            markPropertySet(23, !m_config.loadRelaxed()->isDefaultValue(key));
            auto newValue = qvariant_cast<qlonglong>(value);
            QMetaObject::invokeMethod(this, [this, newValue, key, value]() {
                Q_ASSERT(QThread::currentThread() == this->thread());
        ...
        if (key == QStringLiteral(u"\u0077\u0069\u006e\u0064\u006f\u0077\u0054\u0069\u0074\u006c\u0065\u0062\u0061\u0072\u0048\u0065\u0069\u0067\u0068\u0074")) {
            markPropertySet(24, !m_config.loadRelaxed()->isDefaultValue(key));
            auto newValue = qvariant_cast<qlonglong>(value);
            QMetaObject::invokeMethod(this, [this, newValue, key, value]() {
                Q_ASSERT(QThread::currentThread() == this->thread());
