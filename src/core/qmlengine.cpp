...
QmlEngine::QmlEngine(QObject *parent)
    ...
    , launchAnimationComponent(this, "Treeland", "LaunchAnimation")
...
QQuickItem *QmlEngine::createLaunchAnimation(SurfaceWrapper *surface,
                                              const QRectF &startGeo,
                                              const QRectF &endGeo,
                                              QQuickItem *parent)
{
    return createComponent(launchAnimationComponent,
                           parent,
                           {
                               { "surface", QVariant::fromValue(surface) },
                               { "fromGeometry", QVariant::fromValue(startGeo) },
