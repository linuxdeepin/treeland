    ...
    , m_RSA(nullptr)
{
    ...
    if (!QDBusConnection::sessionBus().connect("org.deepin.dde.Authenticate1",
                                               "/org/deepin/dde/Authenticate1",
                                               "org.freedesktop.DBus.Properties",
                                               "PropertiesChanged", this,
            SLOT(onAuthenticateControllerPropertyChanged(QString, QVariantMap, QStringList)))) {
...
void DeepinAuthFramework::PAMAuthentication(const QString &account)
{
    ...
    const char *serviceName = PAM_SERVICE_DEEPIN_NAME;
...
void DeepinAuthFramework::onAuthenticateControllerPropertyChanged(const QString &name, const QVariantMap &value, const QStringList &list)
{
