...
#include "Authenticate1.h"
#include "AuthenticateSession2.h"

#define AUTHRNTICATESERVICE "org.deepin.dde.Authenticate1"
#define AUTHRNTICATEINTERFACE "org.deepin.dde.Authenticate1.Session"

using AuthInter = Authenticate1;
using AuthControllerInter = AuthenticateSession2;
...
public slots:
    ...
    void onAuthenticateControllerPropertyChanged(const QString &name, const QVariantMap &value, const QStringList &list);
