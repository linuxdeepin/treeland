...
public:
    ...
    using WindowTransitionRectConsumer =
        std::function<void(const QString &token, wl_resource *tokenResource)>;
    ...
    void setWindowTransitionRectConsumer(WindowTransitionRectConsumer consumer);
