...
protected:
    ...
    void treeland_dde_shell_manager_v1_get_treeland_lockscreen(Resource *resource,
                                                               uint32_t id) override;
    void treeland_dde_shell_manager_v1_move_xwayland_surface(Resource *resource,
                                                             uint32_t callback,
                                                             uint32_t wid,
...
void DDEShellManagerInterfaceV1Private::treeland_dde_shell_manager_v1_move_xwayland_surface(Resource *resource,
                                                                                            uint32_t callback,
                                                                                            uint32_t wid,
                                                                                            struct ::wl_resource *anchor,
                                                                                            int32_t dx,
                                                                                            int32_t dy)
{
    ...
    uint32_t ok = wsurface && Helper::instance()->moveXWaylandSurface(wid, wsurface, dx, dy) ? 0 : 1;
