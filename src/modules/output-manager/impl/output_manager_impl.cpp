                                                        ...
                                                        uint32_t temperature)
{
    ...
    if (temperature < 1500 || temperature > 15000) {
        wl_resource_post_error(resource,
                               TREELAND_OUTPUT_COLOR_CONTROL_V1_ERROR_INVALID_COLOR_TEMPERATURE,
                               "Color temperature must be between 1500K and 15000K");
        return;
    }
...
{
    treeland_output_color_control_v1_send_brightness(this->resource, wl_fixed_from_double(brightness));
}
