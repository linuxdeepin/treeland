...
public:
    ...
    // ---- QtQuick scene inspection ----
    // Dumps the QQuickItem hierarchy of a window (id != 0) or the whole
    // render window (id == 0) as a pre-formatted text tree.
    QString getSceneTree(qint64 id) override;
