...
public:
    ...
    WSurface *snapMaskSurface() const;
    void setSnapMaskSurface(WSurface *surface);
...
private:
    ...
    void onStartRequested(treeland_snap_target_v1 *snap, uint32_t events);
    ...
    QPointer<WSurface> m_snapMaskSurface;
