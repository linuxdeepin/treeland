                                                                         ...
                                                                         struct wl_array *outputs)
{
    ...
    virtual_output->send_outputs(outputs);
...
void treeland_virtual_output_v1::send_outputs(struct wl_array *outputs)
{
    treeland_virtual_output_v1_send_outputs(resource,outputs);
}
...
// void treeland_virtual_output_manager_v1::set_desktop(uint32_t state)
// {
//     this->state = state;
