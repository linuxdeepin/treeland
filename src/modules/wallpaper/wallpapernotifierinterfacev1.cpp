...
void TreelandWallpaperNotifierInterfaceV1::send_add(TreelandWallpaperInterfaceV1::WallpaperType type, const QString &fileSource)
{
...
void TreelandWallpaperNotifierInterfaceV1::send_remove(const QString &fileSource)
{
    for (auto resource : d->m_resource) {
