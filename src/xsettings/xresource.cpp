...
QString XResource::toString(XResourceKey key)
{
    switch (key) {
    ...
    case Xcursor_ThemeCore: return "Xcursor.theme_core";
...
void XResource::reload()
{
    ...
    if (!reply) {
        qCCritical(treelandXsettings) << "xcb_intern_atom_reply return nullptr, atom:" << XRESOURCE_ATOM_NAME;
        return;
    }
