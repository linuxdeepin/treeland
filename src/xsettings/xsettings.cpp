...
QString XSettings::toString(XSettingsKey key)
{
    switch (key) {
    case Xft_DPI: return "Xft/DPI";
    case Xft_Antialias: return "Xft/Antialias";
    case Xft_Hinting: return "Xft/Hinting";
    case Xft_HintStyle: return "Xft/HintStyle";
    case Xft_RGBA: return "Xft/RGBA";
    case Xft_LCDFilter: return "Xft/Lcdfilter";

    case Xcursor_Theme: return "Xcursor/Theme";
    case Xcursor_Size: return "Xcursor/Size";
    case Xcursor_ThemeCore: return "Xcursor/ThemeCore";

    case Gdk_WindowScalingFactor: return "Gdk/WindowScalingFactor";
    case Gdk_UnscaledDPI: return "Gdk/UnscaledDPI";

    case Gtk_FontName: return "Gtk/FontName";
    case Gtk_ThemeName: return "Gtk/ThemeName";
    case Gtk_IconThemeName: return "Gtk/IconThemeName";
    case Gtk_CursorThemeName: return "Gtk/CursorThemeName";
    case Gtk_CursorThemeSize: return "Gtk/CursorThemeSize";
    case Gtk_RecentFilesEnabled: return "Gtk/RecentFilesEnabled";
    case Gtk_ShowStatusShapes: return "Gtk/ShowStatusShapes";
    case Gtk_ShowInputMethodMenu: return "Gtk/ShowInputMethodMenu";
    case Gtk_TimeoutInitial: return "Gtk/TimeoutInitial";
    case Gtk_TimeoutRepeat: return "Gtk/TimeoutRepeat";
    case Gtk_DecorationLayout: return "Gtk/DecorationLayout";
    case Gtk_IMModule: return "Gtk/IMModule";
    case Gtk_ShellShowsDesktop: return "Gtk/ShellShowsDesktop";
    case Gtk_MenuImages: return "Gtk/MenuImages";
    case Gtk_EnablePrimaryPaste: return "Gtk/EnablePrimaryPaste";
    case Gtk_KeynavUseCaret: return "Gtk/KeynavUseCaret";
    case Gtk_ShellShowsAppMenu: return "Gtk/ShellShowsAppMenu";
    case Gtk_CanChangeAccels: return "Gtk/CanChangeAccels";
    case Gtk_DialogsUseHeader: return "Gtk/DialogsUseHeader";
    case Gtk_ToolbarStyle: return "Gtk/ToolbarStyle";
    case Gtk_KeyThemeName: return "Gtk/KeyThemeName";
    case Gtk_IMPreeditStyle: return "Gtk/IMPreeditStyle";
    case Gtk_EnableAnimations: return "Gtk/EnableAnimations";
    case Gtk_ToolbarIconSize: return "Gtk/ToolbarIconSize";
    case Gtk_IMStatusStyle: return "Gtk/IMStatusStyle";
    case Gtk_RecentFilesMaxAge: return "Gtk/RecentFilesMaxAge";
    case Gtk_Modules: return "Gtk/Modules";
    case Gtk_AutoMnemonics: return "Gtk/AutoMnemonics";
    case Gtk_ColorScheme: return "Gtk/ColorScheme";
    case Gtk_MenuBarAccel: return "Gtk/MenuBarAccel";
    case Gtk_ColorPalette: return "Gtk/ColorPalette";
    case Gtk_OverlayScrolling: return "Gtk/OverlayScrolling";
    case Gtk_SessionBusId: return "Gtk/SessionBusId";
    case Gtk_ShowUnicodeMenu: return "Gtk/ShowUnicodeMenu";
    case Gtk_CursorBlinkTimeout: return "Gtk/CursorBlinkTimeout";
    case Gtk_ButtonImages: return "Gtk/ButtonImages";
    case Gtk_TitlebarRightClick: return "Gtk/TitlebarRightClick";
    case Gtk_TitlebarDoubleClick: return "Gtk/TitlebarDoubleClick";
    case Gtk_TitlebarMiddleClick: return "Gtk/TitlebarMiddleClick";
    case Gtk_MonospaceFontName: return "Gtk/MonospaceFontName";
    case Gtk_ApplicationPreferDarkTheme: return "Gtk/ApplicationPreferDarkTheme";
    case Gtk_PrimaryButtonWarpsSlider: return "Gtk/PrimaryButtonWarpsSlider";

    case Net_DndDragThreshold: return "Net/DndDragThreshold";
    case Net_CursorBlinkTime: return "Net/CursorBlinkTime";
    case Net_ThemeName: return "Net/ThemeName";
    case Net_DoubleClickTime: return "Net/DoubleClickTime";
    case Net_CursorBlink: return "Net/CursorBlink";
    case Net_FallbackIconTheme: return "Net/FallbackIconTheme";
    case Net_EnableEventSounds: return "Net/EnableEventSounds";
    case Net_IconThemeName: return "Net/IconThemeName";
    case Net_SoundThemeName: return "Net/SoundThemeName";
    case Net_EnableInputFeedbackSounds: return "Net/EnableInputFeedbackSounds";
    case Net_PreferDarkTheme: return "Net/PreferDarkTheme";
