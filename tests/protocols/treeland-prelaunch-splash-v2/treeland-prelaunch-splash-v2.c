...
/*
 * Pure-C Wayland client for the treeland-prelaunch-splash-v2 protocol test.
 */
#ifndef _POSIX_C_SOURCE
#define _POSIX_C_SOURCE 200809L /* shm_open, ftruncate, mmap under strict C11 */
#endif
...
{
    /* The icon arg is a wl_buffer; the fixture must advertise wl_shm to build one. */
    if (!ctx->shm)
        return 0;
    const int stride = 4; /* 1x1 ARGB8888 */
...
{
    /* PrelaunchSplash emits splashRequested per create_splash, no dedup by appId. */
