# `treeland-screensaver-v2` 测试规范

## 范围

- 测试源码：`tests/protocols/treeland-screensaver-v2/`、`tests/protocols/treeland-screensaver-desktop-v2/`
...
随后客户端发送 `treeland_screensaver_v2.inhibit("protocol-test", "desktop idle inhibition")`，
...
`treeland_screensaver_v2.uninhibit()`，在最多 500ms 内同一个 listener 必须收到恰好
