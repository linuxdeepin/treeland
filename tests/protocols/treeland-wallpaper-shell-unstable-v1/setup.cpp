...
/*
 * Hooks invoked from the pure-C client through protocol_test_invoke_server.
 * The emit helpers drive client-observable events (play/pause/slow_down);
 * the query helpers report server-side state produced by client requests.
 */
extern "C" {
