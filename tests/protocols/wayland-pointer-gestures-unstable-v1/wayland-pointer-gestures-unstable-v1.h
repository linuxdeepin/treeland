 ...
 * real wlr_pointer_gestures_v1 handle.  The test locates its client by PID,
 * then counts only that client's resources in the real
 * wlr_pointer_gestures_v1::swipes and ::pinches lists.  This proves the
 * gesture resources were registered in the real compositor's gesture manager
