...
{
public:
    Property(xcb_connection_t *conn, xcb_window_t win, xcb_atom_t prop,
             xcb_atom_t type, uint32_t offset = 0, uint32_t length = 1024);
    Property();
    ~Property();
...
void setProperty(xcb_connection_t *conn, xcb_window_t win, xcb_atom_t prop,
