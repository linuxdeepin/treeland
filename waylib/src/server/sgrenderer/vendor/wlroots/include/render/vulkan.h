...
// Source path: include/render/vulkan.h
// Modifications: Updated to 0.19.3: sync API split — vulkan_sync_render_buffer→vulkan_sync_render_pass_release, new vulkan_sync_foreign_texture_acquire and vulkan_sync_render_buffer_acquire.
