...
// Source path: include/wlr/render/wlr_renderer.h
// Modifications: Vendored to provide struct definitions (struct wlr_renderer,
//   struct wlr_texture, struct wlr_render_pass) that some distro wlroots-0.19
//   packages ship as opaque (forward-declared only). Upstream wlroots 0.19.3
//   defines these in public headers; this vendored copy restores those definitions.
