...
// Source path: render/vulkan/renderer.c
// Modifications: Updated to 0.19.3: descriptor set allocation handles VK_ERROR_FRAGMENTED_POOL and VK_ERROR_OUT_OF_POOL_MEMORY.
