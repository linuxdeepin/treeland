...
class Q_DECL_HIDDEN Helper : public QObject
{
    ...
    Q_PROPERTY(QString damageVisual READ damageVisual WRITE setDamageVisual NOTIFY damageVisualChanged)
...
public:
    ...
    QString damageVisual() const;
    void setDamageVisual(const QString &mode);
    QString damageDebugMode() const { return damageVisual(); }
    void setDamageDebugMode(const QString &mode) { setDamageVisual(mode); }
...
private:
    ...
    QPointer<WOutputRenderWindow> m_window;
};
