...
Item {
    ...
    readonly property int blurPad: 16
    ...
    property alias lockScene: lockScene
    ...
    function showLockscreen() {
        ...
        lockScene.visible = true
        // Settle chip geometry in the frame it changes: the 150ms expand
        // Behaviors must not race damage frame capture.
        lockScene.testMode = true
        lockScene.resetLock()
        lockScene.passwordField.forceActiveFocus()
    }

    function openSessionPopup() {
        lockScene.openSessionPopup()
    }

    function closeSessionPopup() {
        lockScene.closeSessionPopup()
    }

    function scrollSessionList(dy) {
        lockScene.scrollSessionList(dy)
    }

    function blinkLockCaret() {
        lockScene.blinkCaret()
    }

    function startLockHideSource() {
        lockScene.startHideSource()
    }

    function stopLockHideSource() {
        lockScene.stopHideSource()
    }
